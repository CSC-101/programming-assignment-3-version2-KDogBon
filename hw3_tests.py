...
justCA = [data.CountyDemographics(
    ...
    data.CountyDemographics(
        ...
        {'2010 Population': 200849,
         ...
         'Population per Square Mile': 197.9},
        'CA')]
justID = [data.CountyDemographics({'Percent 65 and Older': 19.6, 'Percent Under 18 Years': 25.6, 'Percent Under 5 Years': 4.9}, "Butte County", {"Bachelor's Degree or Higher": 17.9, 'High School or Higher': 89.2}, {'American Indian and Alaska Native Alone': 1.0, 'Asian Alone': 0.3, 'Black Alone': 0.2, 'Hispanic or Latino': 5.8, 'Native Hawaiian and Other Pacific Islander Alone': 0.2, 'Two or More Races': 2.3, 'White Alone': 96.1, 'White Alone, not Hispanic or Latino': 90.6}, {'Per Capita Income': 20995, 'Persons Below Poverty Level': 15.7, 'Median Household Income': 41131}, {'2010 Population': 2891, '2014 Population': 2622, 'Population Percent Change': -9.4, 'Population per Square Mile': 1.3}, "ID")]

educationGreaterThan5 = [data.CountyDemographics(
...
educationLessThan5 = [data.CountyDemographics(
...
ethnicityGreaterThan2 = [data.CountyDemographics(
    {'Percent 65 and Older': 15.3, 'Percent Under 18 Years': 25.1, 'Percent Under 5 Years': 6.0},
    "Crawford County",
    {"Bachelor's Degree or Higher": 14.3, 'High School or Higher': 82.2},
    {'American Indian and Alaska Native Alone': 2.5, 'Asian Alone': 1.6, 'Black Alone': 1.6, 'Hispanic or Latino': 6.7, 'Native Hawaiian and Other Pacific Islander Alone': 0.1, 'Two or More Races': 2.8, 'White Alone': 91.5, 'White Alone, not Hispanic or Latino': 85.6},
...
ethnicityLessThan2 = [data.CountyDemographics(
    {'Percent 65 and Older': 13.8, 'Percent Under 18 Years': 25.2, 'Percent Under 5 Years': 6.0},
    "Autauga County",
    {"Bachelor's Degree or Higher": 20.9, 'High School or Higher': 85.6},
    {'American Indian and Alaska Native Alone': 0.5, 'Asian Alone': 1.1, 'Black Alone': 18.7, 'Hispanic or Latino': 2.7, 'Native Hawaiian and Other Pacific Islander Alone': 0.1, 'Two or More Races': 1.8, 'White Alone': 77.9, 'White Alone, not Hispanic or Latino': 75.6},
...
belowPovertyLevelGreaterThan15 = [data.CountyDemographics(
    {'Percent 65 and Older': 15.3, 'Percent Under 18 Years': 25.1, 'Percent Under 5 Years': 6.0},
    "Crawford County",
    {"Bachelor's Degree or Higher": 14.3, 'High School or Higher': 82.2},
    {'American Indian and Alaska Native Alone': 2.5, 'Asian Alone': 1.6, 'Black Alone': 1.6, 'Hispanic or Latino': 6.7, 'Native Hawaiian and Other Pacific Islander Alone': 0.1, 'Two or More Races': 2.8, 'White Alone': 91.5, 'White Alone, not Hispanic or Latino': 85.6},
...
belowPovertyLevelLessThan15 = [data.CountyDemographics(
    {'Percent 65 and Older': 13.8, 'Percent Under 18 Years': 25.2, 'Percent Under 5 Years': 6.0},
    "Autauga County",
    {"Bachelor's Degree or Higher": 20.9, 'High School or Higher': 85.6},
    {'American Indian and Alaska Native Alone': 0.5, 'Asian Alone': 1.1, 'Black Alone': 18.7, 'Hispanic or Latino': 2.7, 'Native Hawaiian and Other Pacific Islander Alone': 0.1, 'Two or More Races': 1.8, 'White Alone': 77.9, 'White Alone, not Hispanic or Latino': 75.6},
...
class TestCases(unittest.TestCase):
    ...
    def test_by_state_population_1(self):
        ...
        self.assertEqual(justCA, actual)
    def test_by_state_population_2(self):

        actual = hw3.filter_by_state(reduced_data, "ID")
        self.assertEqual(justID, actual)

    # Part 3
    # test population_by_education
    def test_population_by_education_1(self):
        actual = hw3.population_by_education(full_data, "Bachelor's Degree or Higher")
        self.assertEqual(92216021.02199993, actual)

    def test_population_by_education_2(self):
        actual = hw3.population_by_education(full_data, "Bachelor's Degree or Higher")
        self.assertNotEqual(1, actual)

    # test population_by_ethnicity
    def test_population_by_ethnicity_1(self):
        actual = hw3.population_by_ethnicity(full_data, "Two or More Races")
        self.assertEqual(7991261.383000009, actual)

    def test_population_by_ethnicity_2(self):
        actual = hw3.population_by_ethnicity(full_data, "Two or More Races")
        self.assertNotEqual(7, actual)
    # test population_below_poverty_level

    def test_population_below_poverty_level(self):
        actual = hw3.population_below_poverty_level(full_data)
    ...
    def test_population_below_poverty_level_2(self):
        ...
        self.assertEqual(107711.714, actual)
    ...
    def test_percent_by_education(self):
        actual = hw3.percent_by_education(reduced_data, "Bachelor's Degree or Higher")
        self.assertEqual(3.75795298998612, actual)
    def test_percent_by_education_2(self):
        actual = hw3.percent_by_education(full_data, "Bachelor's Degree or Higher")
        self.assertEqual(4.006080511090342, actual)

    # test percent_by_ethnicity
    def test_percent_by_ethnicity(self):
        actual = hw3.percent_by_ethnicity(reduced_data, "Two or More Races")
        self.assertEqual(3.6007140755062803, actual)

    def test_percent_by_ethnicity_2(self):
        actual = hw3.percent_by_ethnicity(full_data, "Two or More Races")
        self.assertEqual(2.5062206504848397, actual)
    ...
    def test_percent_below_poverty_level_2(self):
        actual = hw3.percent_below_poverty_level(full_data)
        self.assertEqual(15.366286413307403, actual)
    # Part 5


    # test education_greater_than
    def test_education_greater_than_1(self):
        actual = hw3.education_greater_than(reduced_data, "Bachelor's Degree or Higher", 5)
        self.assertEqual(educationGreaterThan5, actual)
    ...
    def test_education_less_than_1(self):
        actual = hw3.education_less_than(reduced_data, "Bachelor's Degree or Higher", 5)
        self.assertEqual(educationLessThan5, actual)
    ...
    def test_ethnicity_greater_than_1(self):
        actual = hw3.ethnicity_greater_than(reduced_data, "Two or More Races", 2)
        self.assertEqual(ethnicityGreaterThan2, actual)
    ...
    def test_ethnicity_less_than_1(self):
        actual = hw3.ethnicity_less_than(reduced_data, "Two or More Races", 2)
        self.assertEqual(ethnicityLessThan2, actual)
    ...
    def test_below_poverty_level_greater_than_1(self):
        ...
        self.assertEqual(belowPovertyLevelGreaterThan15, actual)
    ...
    def test_below_poverty_level_less_than_1(self):
        ...
        self.assertEqual(belowPovertyLevelLessThan15, actual)
